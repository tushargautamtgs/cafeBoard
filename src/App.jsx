...
const MENU = [
  ...
  },
  {
    ...
    popular: true,
    rating: 4.7,
    img: "https://images.unsplash.com/photo-1527169402691-a98e8d6f6b5b?q=80&w=1200&auto=format&fit=crop",
    tags: ["cold", "bold"],
  },
  {
    id: 6,
    ...
    popular: true,
    rating: 4.6,
    img: "https://images.unsplash.com/photo-1461988625982-7e46a099bf4f?q=80&w=1200&auto=format&fit=crop",
    tags: ["cold", "milky"],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    popular: true,
    rating: 4.9,
    img: "https://images.unsplash.com/photo-1542367597-8849ebf9bde2?q=80&w=1200&auto=format&fit=crop",
    tags: ["spiced", "hot"],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    popular: false,
    rating: 4.2,
    img: "https://images.unsplash.com/photo-1465929639680-64ee08f0f13b?q=80&w=1200&auto=format&fit=crop",
...
function App() {
  ...
  const [cart, setCart] = useState(
    JSON.parse(localStorage.getItem("cc_cart_v1") || "[]")
  );
  ...
  const cartTotal = cart.reduce(
    (sum, c) => sum + (MENU.find((m) => m.id === c.id)?.price || 0) * c.qty,
    0
  );
  ...
  return (
    <div>
      ...
      <header>
        <div className="container nav">
          <div className="brand">
            ...
            <span className="chip" title="Open 7:00–21:00">
              Open • 7am–9pm
            </span>
          </div>
      ...
      <main id="top">
        ...
        <section className="container hero">
          <div>
            ...
            <p className="muted">
              Freshly roasted beans, handcrafted with love. Practice project to
              master <strong>React + CSS</strong>.
            </p>
          ...
          <div
            className="banner"
            role="img"
            aria-label="A cup of coffee on a wooden table"
          >
        ...
        <section className="container about">
          <div>
            ...
            <p>
              We brew with ethically sourced beans, slow-roasting to unlock
              layered flavors. Demonstrates React, hooks, state management and
              responsive design.
            </p>
          ...
          <img
            src="https://images.unsplash.com/photo-1517701604599-bb29b565090c?q=80&w=1300&auto=format&fit=crop"
                  ...
                  <div className="content">
                    ...
                    <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                      ...
                      <button
                        ...
                        onClick={() =>
                          showToast(
                            `${m.title}: ₹${money(m.price)} • ${m.tags.join(
                              ", "
                            )}`,
                            3000
                          )
        ...
        <section className="container" id="pricing">
          ...
          <p className="muted" style={{ marginTop: 8 }}>
            * Actual prices may vary by milk type and add-ons.
          </p>
        </section>
            ...
            <fieldset>
              ...
              <div>
                ...
                <input
                  ...
                  name="message"
                  rows={4}
                  placeholder="Allergies, celebration notes, etc."
                ></input>
              </div>
            </fieldset>
            <div
      ...
      <footer>
        © {new Date().getFullYear()} Coffee Corner •{" "}
